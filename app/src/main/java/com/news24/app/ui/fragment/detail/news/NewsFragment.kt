...
import com.news24.app.databinding.FragmentNewsBinding
...
import com.news24.app.ui.fragment.detail.news.adapter.NewsAdapter
...
class NewsFragment: BaseFragment(), NewsContract.View {
    ...
    @Inject
    lateinit var presenterProvider: Provider<NewsContract.Presenter>

    @Inject
    lateinit var adapter: NewsAdapter

    private val fragmentBinding by lazy { FragmentNewsBinding.inflate(layoutInflater) }
    ...
    companion object {
        ...
        fun newInstance(params: NewsScreenParams): NewsFragment {
    ...
    private fun configureDI() {
        val params = requireArguments().getParcelable<NewsScreenParams>(KEY_PARAMS)!!

        val component = getAppComponent().plus(NewsModule(requireActivity(), params))
        component.inject(this)
    }

    @ProvidePresenter
    internal fun providePresenter(): NewsContract.Presenter {
