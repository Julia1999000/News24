package com.news24.app.ui.other.transformation;
...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    private void drawDiagonalFromTopLeftRoundRect(Canvas canvas, Paint paint, float right,
        ...
        canvas.drawRoundRect(new RectF(margin, margin, margin + diameter, margin + diameter),
                radius, radius, paint);
        canvas.drawRoundRect(new RectF(right - diameter, bottom - diameter, right, bottom),
                radius, radius, paint);
    ...
    private void drawDiagonalFromTopRightRoundRect(Canvas canvas, Paint paint, float right, float bottom) {
        canvas.drawRoundRect(new RectF(right - diameter, margin, right, margin + diameter),
                radius, radius, paint);
